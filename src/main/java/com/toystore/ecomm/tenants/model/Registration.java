...
public class Registration {
	...
	private String tenantMobile = null;
	...
	public Registration tenantMobile(String tenantMobile) {
	 ...
	 * @return tenantEmail
	 **/
	@ApiModelProperty(required = true, value = "This is the Mobile No. of the tenant")
	@NotNull
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.tenantId, registration.tenantId)
				...
				&& Objects.equals(this.tenantMobile, registration.tenantMobile)
	...
	@Override
	public int hashCode() {
		return Objects.hash(tenantName, tenantEmail, tenantMobile, tenantUsername, tenantPassword, tenantVerified);
	}
	...
	public String toString() {
		...
		sb.append("    tenantMobile: ").append(toIndentedString(tenantMobile)).append("\n");
