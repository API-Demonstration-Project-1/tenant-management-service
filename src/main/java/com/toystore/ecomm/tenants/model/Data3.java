...
public class Data3   {
  ...
  static {
	  UIModelFactory.register("DATA3", Data3.class);
  }
	 
  @JsonProperty("response")
  private List<Registration> response = null;

  public Data3 response(List<Registration> response) {
  ...
  **/
  ...
  public List<Registration> getResponse() {
    return response;
  }

  public void setResponse(List<Registration> response) {
    this.response = response;
  }
